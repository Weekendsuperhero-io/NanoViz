...
# Invoke from the host: podman exec nanoviz /usr/local/bin/diag.sh > capture.txt 2>&1
...
section "mDNS resolve nanoviz"
avahi-resolve -n "nanoviz._airplay._tcp.local" 2>&1 || true
